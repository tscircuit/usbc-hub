...
export const USBLC6_2SC6 = (props: ChipProps<typeof pinLabels>) => {
  ...
  "jlcpcb": [
    "C2687116"
      ...
      pinAttributes={{
        IO1_IN: { mustBeConnected: true },
        GND: { requiresGround: true, mustBeConnected: true },
        IO2_IN: { mustBeConnected: true },
        IO2_OUT: { mustBeConnected: true },
        VBUS: { requiresPower: true, mustBeConnected: true },
        IO1_OUT: { mustBeConnected: true },
      }}
      footprint={<footprint>
